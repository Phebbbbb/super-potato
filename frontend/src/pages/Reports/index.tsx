...
import { Card, Table, Select, Button, Space, App, Spin, Typography, Tabs } from 'antd'
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 24 }}>
        <Typography.Title level={4} style={{ margin: 0 }}>财务报表</Typography.Title>
        <Space>
      ...
      <Tabs
        defaultActiveKey="trial-balance"
        items={[
          {
            key: 'trial-balance',
            label: '科目余额表',
